 ...
 * Data: 14 jobs and 10 tasks with job references.
 */
export async function seedDemoDataForUser(userId) {
  ...
  const rawJobData = [
    ...
    { companyName: 'Baidu', jobTitle: 'AI平台后端开发', status: '感兴趣', city: '北京', salaryRange: '30K-48K', workMode: ' onsite', channel: '', priority: '高', appliedDate: '', jobLink: 'https://example.com/baidu', jdText: '负责AI平台后端服务开发...', contactName: '', contactInfo: '', nextAction: '修改简历后投递', notes: '需要准备系统设计', endReason: '', timeline: [] },
    ...
    { companyName: 'Bilibili', jobTitle: 'Go 后端开发', status: '感兴趣', city: '上海', salaryRange: '28K-42K', workMode: ' onsite', channel: '内推', priority: '中', appliedDate: '', jobLink: '', jdText: '', contactName: '陈学姐', contactInfo: 'B站内部', nextAction: '联系学姐了解详情', notes: '', endReason: '', timeline: [] },
  ...
  const taskData = [
    ...
    { title: '复习系统设计', type: '准备任务', date: '2026-05-12', startTime: '20:00', endTime: '22:00', priority: '中', done: false, jobId: null, notes: '分布式系统常见面试题' },
    ...
    { title: 'LeetCode 每日一题', type: '准备任务', date: '2026-05-12', startTime: '09:00', endTime: '10:00', priority: '低', done: true, jobId: null, notes: '' },
